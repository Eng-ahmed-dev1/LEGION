...
{
    public class ActivateGameweekCommandHandler : IRequestHandler<ActivateGameweekCommand, Result<Unit>>
    {
        private readonly IGameweekRepository _gameweekRepository;
        private readonly IUnitOfWork _unitOfWork;

        public ActivateGameweekCommandHandler(IGameweekRepository gameweekRepository, IUnitOfWork unitOfWork)
        {
            _gameweekRepository = gameweekRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Result<Unit>> Handle(ActivateGameweekCommand request, CancellationToken cancellationToken)
        {
