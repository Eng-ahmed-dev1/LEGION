...
{
    public class MoveToBenchCommandHandler : IRequestHandler<MoveToBenchCommand, Result<Unit>>
    {
        private readonly IFantasyPlayerRepository _fantasyPlayerRepository;
        private readonly IUnitOfWork _unitOfWork;

        public MoveToBenchCommandHandler(IFantasyPlayerRepository fantasyPlayerRepository, IUnitOfWork unitOfWork)
        {
            _fantasyPlayerRepository = fantasyPlayerRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Result<Unit>> Handle(MoveToBenchCommand request, CancellationToken cancellationToken)
        {
